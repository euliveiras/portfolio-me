    ...
    return (
        ...
        >
            <Flex
                ...
                align="center"
            >
                <Text color="blue.900" w="40%" m="0 auto" fontFamily="body" fontSize="xl">
                ...
                <Image borderRadius="4" src="/me.png" w="40%" h="80%" m="0 auto" backgroundColor="blue.900" alt="foto de matheus"/>
            </Flex>
        </Box>
    );
}